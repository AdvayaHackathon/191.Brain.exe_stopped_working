    ...
    return (
        <div className="fixed top-[17%] rounded-xl h-[80%] left-[10%] w-[80%] bg-black/15 flex flex-col">
            ...
            <div className="h-[15%] flex flex-col items-center">
                <div className="w-[60%] bg-black/30 h-full rounded-xl p-2">
                    {imagePreviewUrls.length > 0 && (
                        <div className="flex flex-wrap gap-2 mb-2 max-h-12 overflow-x-auto">
                    ...
                    <div className="w-full bg-black/20 rounded-xl flex-1 flex items-center">
                        <textarea
                            value={inputMessage}
                            onChange={(e) => setInputMessage(e.target.value)}
                            onKeyDown={handleKeyPress}
                            placeholder="Ask me anything..."
                            className="w-full h-full font-pixel text-xs text-orange-300 tracking-tighter bg-transparent border-none resize-none outline-none p-2"
                        />
                        ...
                        <button 
                            ...
                            className="mr-2 text-purple-400 hover:text-purple-300 transition-colors"
                        >
